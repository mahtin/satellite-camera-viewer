...
def viewer(args=None):
	...
	# top
	starfield_graph_frame = ui.frame(top_frame, col=0, padx=1, pady=1, borderwidth=0, relief='', sticky='nw')
	adjustments_frame = ui.frame(top_frame, col=1, padx=1, pady=1, borderwidth=0, relief='', sticky='ne')
	# bottom
