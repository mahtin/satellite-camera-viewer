...
class ConstellationDatabase:
    ...
    _data = [
        ...
        ['Camelopardalis',      'Cam',      'Caml',      'Camelopardalis',      '1613,Plancius',            'giraffe',                           'β Camelopardalis', '4.02'],
        ...
        ['Chamaeleon',          'Cha',      'Cham',      'Chamaeleontis',       '1598,Plancius,Keyser,de Houtman',    'chameleon',        'α Chamaeleontis',    '4.06'],
        ...
        ['Hercules',            'Her',      'Herc',      'Herculis',            'ancient (Ptolemy)',        'Hercules(mythological character)',    'Kornephoros',    '2.81'],
        ...
        ['Libra',               'Lib',      'Libr',      'Librae',              'ancient (Ptolemy)',        'balance',    'Zubeneschamali',    '2.61'],
