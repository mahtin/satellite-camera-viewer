...
class ISSAttitude:
    ...
    # EARTH_RADIUS_KM = 6378.137 # Earth's equatorial radius used in ellipsoidal model (now uses R_earth)
    ...
    def propagate_from_tle(cls, tle_line1: str, tle_line2: str):
        """
        Returns (r_eci_km, v_eci_km_s) from a two-line TLE.
        Output units:
          r_eci : km
          v_eci : km/s
        """
    ...
    def lvlh_frame(cls, r_eci, v_eci):
        """
        Returns LVLH frame unit vectors from ECI position and velocity.
